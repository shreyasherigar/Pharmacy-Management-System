	...
	<link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
		...
		<style >
      		*{
      		...
      		body::before{
      		   content:"";
      		   background:url("photos/hc.jpeg")no-repeat center center/cover;
      		   width:100%;
      		   height:100%;
      		   position:absolute;
      		   top:0px;left:0px;
...
<body>
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item">
	         ...
	         <li class="nav-item">
	          <a class="nav-link active" href="health_care.jsp"><b>Healthcare products</b></a>
	        </li>
	         <li class="nav-item">
	...
	<div class="medicine_section mt-2">
		<h1 style="text-align:center; font-family:merithwater; font-weight:35px; color:black;font-weight:bold;margin-top:80px;">Health Care Products</h1>
     	<%
				  ...
				  <tbody class="tbody" >
     	  				...
     	  				// System.out.println(pin);
     	  				 ...
     	  				 try{
     	  					...
     	  					st=con.createStatement();
     	  					 ...
     	  					 String qry="select * from health_care";
     	  			 ...
     	  			 %>
     	  			        <tr>
	     						...
	     						<%}else{
	     							%>
	     							 <form action="Add_to_cart_health" method="post">			
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form class="form col-lg-8 col-sm-12 shadow-lg m-auto " action="Health_care" method="post">
					          ...
					          <div class="form-group m-2">
									...
									<input type="text" name="name" class="form-control mt-1" placeholder="Enter Product name">
								</div>
			          	      <div class="form-group m-2">
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content" style="width:30em;">
		      ...
		      <div class="modal-body" style="display:flex; justify-content:center;align-items:center;">
		        <form class="form col-lg-8 col-sm-12 shadow-lg  " action="Add_to_cart_health" method="post">
		...
		<div class="modal fade " id="remove" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content" style="width:30em;">
		      ...
		      <div class="modal-body" style="display:flex; justify-content:center;align-items:center;">
		        <form class="form col-lg-8 col-sm-12 shadow-lg  " action="delete_health" method="post">
